...
namespace   Indie
{
    ...
    private:
        ...
        bool    checkUp(std::unique_ptr<APlayer>&, std::unique_ptr<AEntity> const&) const;
        bool    checkDown(std::unique_ptr<APlayer>&, std::unique_ptr<AEntity> const&) const;
        bool    checkLeft(std::unique_ptr<APlayer>&, std::unique_ptr<AEntity> const&) const;
        bool    checkRight(std::unique_ptr<APlayer>&, std::unique_ptr<AEntity> const&) const;
        /*
    ...
    private:
        ...
        std::map<OIS::KeyCode, bool (Indie::SceneDisplayer::*)(std::unique_ptr<APlayer>&, std::unique_ptr<AEntity> const&) const>  _collideGetter;
